...
#import "Explanation7.h"

@interface Explanation7 ()
...
- (void)characterSettings: (int)scene {
    ...
    //skin 2,3,5,7
    UIColor *skinColour = [UIColor colorWithHue:0 saturation:0.9 brightness:0.9 alpha:1.0];
